...
public final class DeletionVectors
{
            ...
            throws IOException
    {
        ...
        RoaringBitmap bitmap = toRoaringBitmap(rowsDeletedByDelete, rowsDeletedByUpdate);
    ...
    private static RoaringBitmap toRoaringBitmap(LongBitmapDataProvider rowsDeletedByDelete, LongBitmapDataProvider rowsDeletedByUpdate)
    {
